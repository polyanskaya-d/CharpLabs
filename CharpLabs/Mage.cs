...
{
    // Делегати для подій атаки та захисту
    public delegate void AttackHandler(Mage caster, Mage target, ISpell spell);
    public delegate void DefenseHandler(Mage target, int damage);
    ...
    public abstract class Mage
    {
        ...
        // Події атаки та захисту
        public event AttackHandler OnAttack;
        public event DefenseHandler OnDefend;
        ...
        public void Attack(Mage target)
        {
            if (Spells.Count > 0)
            {
                ...
                // Викликаємо подію атаки
                OnAttack?.Invoke(this, target, spell);
            }
            else
            {
        ...
        public void Defend(int damage)
        {
            ...
            // Викликаємо подію захисту
            OnDefend?.Invoke(this, damage);
        }
